...
public class InvitationController {
    ...
    @GetMapping
    public ResponseEntity<InvitationListResponse> getInvitationsByUserId(@RequestParam int userId, HttpSession session) {
//        int userId = ((UserDto)session.getAttribute("userDto")).getId();
    ...
    public ResponseEntity<InvitationAcceptResponse> acceptInvitation(@PathVariable("invite") int inviteId, @RequestParam int userId, HttpSession session) {
//        int userId = ((UserDto)session.getAttribute("userDto")).getId();
    ...
    public ResponseEntity<InvitationRejectResponse> rejectInvitation(@PathVariable("invite") int inviteId, @RequestParam int userId, HttpSession session) {
//        int userId = ((UserDto)session.getAttribute("userDto")).getId();
